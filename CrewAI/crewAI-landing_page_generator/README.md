...
## Notes
- One run takes approx. 30 minutes
- Template "Salient" downloaded from: https://github.com/magnetco/tailwindui-salient
    or (Vue variant): https://github.com/brunomdsilva/salient
    other free templates can be found here: https://www.tailwindawesome.com/?price=free
- Modify config/templates.json according to available templates
- .env File contains keys for OpenAI, Browserless, Serper => not part of commit

## Option 1: Installation via Poetry
Project runs only in Python >=3.10.0 and <3.12
1. Install pipx with Homebrew: https://pipx.pypa.io/stable/installation/

2. Install pyenv / pyenv-virtualenv
- pyenv install 3.11.9
- pyenv virtualenv 3.11.9 myenv3-11-9
- pyenv activate myenv3-11-9

3. Install Poetry : https://python-poetry.org/docs/#installing-with-pipx

4. Install dependencies:
poetry install --no-root

5. Due to a warning install this afterwards (?)
- pip install -U langchain-community

**Start:**
- poetry run python main.py | tee terminal_output.txt
- One run takes approx. 30 minutes
...
# Start:
python main.py | tee terminal_output.txt
python _tool-test_just_for_testing.py | tee terminal_output.txt
